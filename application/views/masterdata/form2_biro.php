    ...
    <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div>
                        <h1 class="card-header white text-center">Form Tambah Biro</h1>
                    </div>
                        ...
                        <div class="card todo-widget">
                            <div class="card-header white">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Biro</li>
                                </ol>
                            </div>
                            <div>
                            ...
                            <form class="card-footer white" action="
                                ...
                                <div class="input-group col-md-12">
                                    <div>
                                        <h6 class="card-header white"> Tambahkan Biro</h6>
                                    </div>
                            ...
                            <table class="table table-bordered table-hover data-tables" data-options='{ "paging": false; "searching":false}'>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Nama Biro</td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group focused">
                    <input class="form-control" type="text" placeholder="Nama Biro">
                </div>
            </div>
