    ...
    <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div>
                        <h1 class="card-header white text-center">Form Tambah Nama Parameter</h1>
                    </div>
                    <div class="card-body b-b">
                        <div class="card todo-widget">
                            ...
                            <div>
                                ...
                                <h6 class="card-header white">Bagian = Nama Bagian</h6>
                                <h6 class="card-header white">Sub Bagian = Nama Sub Bag</h6>
                                <h6 class="card-header white">Database = Nama database</h6>
                            </div>
                            <form class="card-footer white" action="
								<?php echo base_url('Masterdata/inputbagian')?>" method="post">
                                <div class="input-group col-md-12">
                                    <div>
                                        <h6 class="card-header white"> Tambahkan Parameter</h6>
                                    </div>
                                    <input type="hidden" class="form-control form-control-lg" name="id" id="id">
                                    <input name="bidang" id="bidang" type="text" class="form-control" placeholder="Nama Parameter">
                                    <input name="bidang" id="bidang" type="text" class="form-control" placeholder="Jenis Data">
                                    <input name="bidang" id="bidang" type="text" class="form-control" placeholder="Panjang">
                            ...
                            <table class="table table-bordered table-hover data-tables" data-options='{ "paging": false; "searching":false}'>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Nama Parameter</td>
                                        <td class="text-center">Nama Jenis data</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Edit Data Parameter</h4>
            ...
            <div class="modal-body">
                <div class="form-group focused">
                    ...
                    <br>
                    <input class="form-control" type="text" placeholder="Jenis Data">
                    <br>
                    <input class="form-control" type="text" placeholder="Panjang">
                </div>
            </div>
