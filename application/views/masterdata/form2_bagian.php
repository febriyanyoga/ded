    ...
    <div class="container-fluid my-3">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div>
                        <h1 class="card-header white text-center">Form Tambah Bagian</h1>
                    </div>
                        ...
                        <div class="card todo-widget">
                            ...
                            <form class="card-footer white" action="
                                ...
                                <div class="input-group col-md-12">
                                    <div>
                                        <h6 class="card-header white"> Tambahkan Bagian</h6>
                                    </div>
                                    <input type="hidden" class="form-control form-control-lg" name="id" id="id">
                                    <input name="bidang" id="bidang" type="text" class="form-control" placeholder="Nama Biro">
                            ...
                            <table class="table table-bordered table-hover data-tables" data-options='{ "paging": false; "searching":false}'>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Nama Bagian</td>
                                        <td class="text-center">
                                            <a href="
														<?php echo site_url('masterdata/form3_subagian'); ?>"> 
														<i class="btn btn-success btn-sm">Sub Bag / Seksi</i>
                                                    </a>
                                        </td>
                                        <td class="text-center">
                                            <a href="
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group focused">
                    <input class="form-control" type="text" placeholder="Nama Bagian">
                </div>
            </div>
